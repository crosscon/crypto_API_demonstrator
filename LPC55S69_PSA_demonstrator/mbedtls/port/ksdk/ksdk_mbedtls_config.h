...
#if defined(FSL_FEATURE_SOC_HASHCRYPT_COUNT) && (FSL_FEATURE_SOC_HASHCRYPT_COUNT > 0) //&& defined(MBEDTLS_HASHCRYPT_AES)
#include "fsl_hashcrypt.h"

#if defined(MBEDTLS_FREESCALE_HASHCRYPT_AES)    /* Enable use of HASHCRYPT AES.*/
